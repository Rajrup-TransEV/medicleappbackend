...
def getprescribebyidfn():
    ...
    try:
        ...
        # Sort prescriptions by latest first (descending)
        prescriptions = prescribe_collection.find({"patientid": patientid}).sort("created_at", -1)
        ...
        for prescription in prescriptions:
            ...
            if file_path and os.path.exists(file_path):
                ...
                prescription_data['file_data'] = encoded_string
        ...
        generatelogs("success",'Prescriptions have been found','getprescrbbypatientid.py')
        return jsonify(results), 200
        
    except Exception as e:
        messagetype = 'error'
        message = f"Error retrieving prescriptions: {str(e)}"
        filelocation = 'getprescrbbypatientid.py'
